...
exports.getNpmVersion = exports.getNodeVersion = exports.findPackageJson = void 0;
 ...
 * @param fallback
 */
const getNodeVersion = (path, fallback) => {
 ...
 * @param fallback
 */
const getNpmVersion = (path, fallback) => {
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const nodeVersion = (0, getNodeVersion_1.getNodeVersion)(path, fallbackNode);
            const npmVersion = (0, getNodeVersion_1.getNpmVersion)(path, fallbackNpm);
